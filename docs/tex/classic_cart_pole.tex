...
\begin{tikzpicture}
    ...
    \begin{scope}[rotate around={150:(7, 3.1)}]
        ...
        % P
        \filldraw[fill=blue] (7, -1.8) circle [radius=0.1];
        \draw[blue] (7, -2.2) node {\Large \(P\)};

        % l
        \draw[<->, thick, black] (7,3) -- (7, -1.7) node[midway,above] {\large \(l\)};
    \end{scope}
    ...
    % g
    \draw[->, thick, blue!70!black] (9.45, 7.24) -- (9.45, 5.7) node[midway,right] {\large \(g\)};
